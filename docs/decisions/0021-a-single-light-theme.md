...
- Good: every route sheds the toggle chunk. Measured by `test/budget.test.ts` on 2026-09-25, the app's own first-load share falls from 75.1 KB to 26.4 KB on `/` (202.3 KB → 153.6 KB total) and from 81.1 KB to 35.5 KB on `/design` (208.3 KB → 162.7 KB).
